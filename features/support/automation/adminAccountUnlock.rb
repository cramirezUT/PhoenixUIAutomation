...
RSpec.describe "Admin->Account->Unlock: Account Unlock verification test", :adminAccount do
  begin
    before(:all) do
    ...
    after(:each) do |example|
	    if example.exception
  	    screenshot_file = "features/support/automation_screenshots/adminAccountUnlock-#{Time.now.strftime('%Y%m%d-%H%M%S')}.png"

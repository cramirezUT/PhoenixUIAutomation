...
RSpec.describe "Admin->Contest->Inquire->Contest: Contest Inquire Contest verification test", :adminContest do
  begin
    before(:all) do
    ...
    after(:each) do |example|
	    if example.exception
  	    screenshot_file = "features/support/automation_screenshots/adminContestInquireContest-#{Time.now.strftime('%Y%m%d-%H%M%S')}.png"

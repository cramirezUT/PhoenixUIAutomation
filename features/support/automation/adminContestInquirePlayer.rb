...
RSpec.describe "Admin->Contest->Inquire->Player: Contest Inquire Player verification test", :adminContest do
  begin
    before(:all) do
    ...
    after(:each) do |example|
	    if example.exception
  	    screenshot_file = "features/support/automation_screenshots/adminContestInquirePlayer-#{Time.now.strftime('%Y%m%d-%H%M%S')}.png"

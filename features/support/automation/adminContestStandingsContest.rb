...
RSpec.describe "Admin->Contest->Standings->Contest: Contest Standings Contest verification test", :adminContest do
  begin
    before(:all) do
    ...
    after(:each) do |example|
	    if example.exception
  	    screenshot_file = "features/support/automation_screenshots/adminContestStandingsContest-#{Time.now.strftime('%Y%m%d-%H%M%S')}.png"

...
RSpec.describe "Admin->Dealer: Admin Dealer verification test", :adminDealer do
  begin
    before(:all) do
    ...
    after(:each) do |example|
	    if example.exception
  	    screenshot_file = "features/support/automation_screenshots/adminDealer-#{Time.now.strftime('%Y%m%d-%H%M%S')}.png"

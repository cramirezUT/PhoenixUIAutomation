...
RSpec.describe "Admin->Terminal->Cash: Admin Terminal Cash functionality test", :adminTerminal do
  begin
    before(:all) do
    ...
    after(:each) do |example|
	    if example.exception
  	    screenshot_file = "features/support/automation_screenshots/adminTerminalCash-#{Time.now.strftime('%Y%m%d-%H%M%S')}.png"

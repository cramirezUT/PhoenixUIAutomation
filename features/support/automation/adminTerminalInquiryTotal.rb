...
RSpec.describe "Admin->Terminal->Inquiry->Total: Admin Terminal Inquiry Total test", :adminTerminal do
  begin
    before(:all) do
    ...
    after(:each) do |example|
	    if example.exception
  	    screenshot_file = "features/support/automation_screenshots/adminTerminalInquiryTotal-#{Time.now.strftime('%Y%m%d-%H%M%S')}.png"

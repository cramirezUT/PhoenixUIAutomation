...
RSpec.describe "Betting->Ticket->BuyUnbuy: Buy Ticket from Phoenix application", :buy do
  begin
    before(:all) do
      puts "buyTicketTest"
      # launchToteBrowser
  ...
  #
	...
	# 		ticketTicketTextField.wait_until_present.flash.set ($bettingTicketBuyTicketNumber)
	# 		sendKeysEnter
	# 	end
  #

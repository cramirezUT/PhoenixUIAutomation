...
RSpec.describe "Admin->Seller->Edit admin Seller FingerPrint-N1", :sellerEdit do
  begin
    before(:all) do
      puts "adminSellerEditFingerPrint-N1"
      launchToteBrowser
      selectSiteTable
      logInFunction
    end
    ...
    it "FingerPrint" do
      ...
      sellerFingerPrint.flash(color: ["yelllow"])
      sellerFingerPrint.set ("**")
      sendKeysTab
    end

    it "Verify Error" do
       verifyError("Invalid fingerprint")
    end

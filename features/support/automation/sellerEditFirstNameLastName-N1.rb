...
RSpec.describe "Admin->Seller->Edit admin Seller Edit First Name Last Name-N1", :sellerEdit do
  begin
    before(:all) do
      puts "adminSellerEditBothName-N1"
      launchToteBrowser
      selectSiteTable
      logInFunction
    end
    ...
    it "Edit First Name Last Name and clear" do

...
RSpec.describe "Admin->Seller->Edit admin Seller Terminal-P1", :sellerEdit do
  begin
    before(:all) do
      puts "adminSellerEditTerminal-P1"
      launchToteBrowser
      selectSiteTable
      logInFunction
    end
    ...
    it "Terminal" do
      ...
      sellerTerminals.flash(color: ["yelllow"])
      sellerTerminals.set ("123456")
      sendKeysTab
    end
